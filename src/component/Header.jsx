const Header=()=>
 ...
 <>
   <div className="nav-header">
                        <a href="index.html" className="brand-logo d-flex justify-content-center align-items-center gap-2">
                            <svg
                                className="logo-abbr"
                                width={40}
                                height={40}
                          ...
                          <h2 className="m-0 text-white">School</h2> 
                        </a>
                            ...
                            <nav className="navbar navbar-expand">
                                <div className="collapse navbar-collapse justify-content-between">
                                    <div className="header-left">
                                        <div className="dashboard_bar">Add New Student</div>
                                    </div>
