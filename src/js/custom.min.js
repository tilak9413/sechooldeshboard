var Akademi = function() {
    ...
    var t = function() {
        ...
        h = function() {
            jQuery(".menu-wallet").on("click", function() {
                jQuery(".wallet-bar").toggleClass("active"), jQuery(".wallet-open").toggleClass("active"), $(this).toggleClass("main")
            }), jQuery(".wallet-bar-close").on("click", function() {
                jQuery(".wallet-bar").removeClass("active"), jQuery(".wallet-open").removeClass("active")
            }), setTimeout(() => {
        ...
        T = function() {
            if (jQuery(".dz-theme-mode").length > 0) {
                jQuery(".dz-theme-mode").on("click", function() {
                    jQuery(this).toggleClass("active"), jQuery(this).hasClass("active") ? (jQuery("body").attr("data-theme-version", "dark"), setCookie("version", "dark"), jQuery("#theme_version").val("dark")) : (jQuery("body").attr("data-theme-version", "light"), setCookie("version", "light"), jQuery("#theme_version").val("light")), $(".default-select").selectpicker("refresh")
                });
    ...
    return {
        init: function() {
            a(), n(), l(), i(), o(), s(), c(), r(), d(), u(), h(), m(), f(), g(), b(), v(), p(), C(), w(), y(), x(), z(), _(), q(), A(), S(), T(), D(), R(), k()
        },
        load: function() {
            t(), E()
        },
...
jQuery(document).ready(function() {
    ...
    "use strict";
    Akademi.load(), setTimeout(function() {
        Akademi.handleMenuPosition()
    }, 1e3)
}), jQuery(window).on("resize", function() {
    "use strict";
    Akademi.resize(), setTimeout(function() {
        Akademi.handleMenuPosition()
    }, 1e3)
});