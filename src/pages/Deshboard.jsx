            ...
            <div className="row ">
                  ...
                  >
                    ...
                    <div className="d-flex align-items-center student">
                      ...
                      <div className="user-info">
                        <h6 className="name">
                          <a href="app-profile.html">Samantha William</a>
                        </h6>
                        <span className="fs-14 font-w400 text-wrap">Class VII A</span>
                      </div>
                    ...
                    <div className="d-flex align-items-center student">
                      ...
                      <div className="user-info">
                        <h6 className="name">
                          <a href="app-profile.html">Tony Soap</a>
                        </h6>
                        <span className=" text-wrap text-break">Class VII B</span>
                      </div>
                      <div className="icon-box st-box ms-auto">
                        <a href="#">
                          <svg
                    ...
                    <div className="d-flex align-items-center student">
                      ...
                      <div className="user-info">
                        <h6 className="name">
                          <a href="app-profile.html">Karen Hope</a>
                        </h6>
                    ...
                    <div className="d-flex align-items-center student">
                      ...
                      <div className="user-info">
                        <h6 className="name">
                          <a href="app-profile.html">Jordan Nico</a>
                        </h6>
                        <span className=" text-wrap">Class VII A</span>
                      </div>
                      <div className="icon-box st-box ms-auto">
                        <a href="#">
                          <svg
                    ...
                    <div className="d-flex align-items-center student">
                      ...
                      <div className="user-info">
                        <h6 className="name">
                          <a href="app-profile.html">Nadila Adja</a>
                        </h6>
                        <span className=" text-wrap">Class VII B</span>
                      </div>
                      <div className="icon-box st-box ms-auto">
                        <a href="#">
                          <svg
              ...
              <div className="col-xl-12">
                <div className="card massage bg-transparent mb-0">
                  ...
                  >
                    {/*student*/}
                    <div className="d-flex student border-bottom">
              ...
              <div className="col-xl-12 ">
                <div className="card tags bg-transparent mb-0">
                  ...
                  <div className="card-body  p-3 py-1 ">
                    <div className="card-body-inner food">
                      <span className="dz-media">
                        <img src="images/food/pic1.jpg" alt="" className="avatar" />
                      </span>
                      <div className="user-info">
                        <h5 className="name">
                          <a href="app-profile.html">Beef Steak with Fried Potato</a>
                        </h5>
                        <span className="fs-14 font-w400 text-wrap">
                          Lorem ipsum dolor sit
                        </span>
                    ...
                    <div className="card-body-inner food">
                      <span className="dz-media">
                        <img src="images/food/pic2.jpg" alt="" className="avatar" />
                      </span>
                      <div className="user-info">
                        <h5 className="name">
                          <a href="app-profile.html">Pancake with Honey</a>
                        </h5>
                        <span className="fs-14 font-w400 text-wrap">
                          Lorem ipsum dolor sit
                        </span>
                    ...
                    <div className="card-body-inner food">
                      <span className="dz-media">
                        <img src="images/food/pic3.jpg" alt="" className="avatar" />
                      </span>
                      <div className="user-info">
                        <h5 className="name">
                          <a href="app-profile.html">Japanese Beef Ramen</a>
                        </h5>
                        <span className="fs-14 font-w400 text-wrap">
                          Lorem ipsum dolor sit
                        </span>
                        ...
                        <div className="col-xl-3 col-6">
                          <div className="content-box">
                            ...
                            <div className="chart-num">
                              <p>Students</p>
                              <h2 className="font-w700 mb-0">932</h2>
                            </div>
                          </div>
                        </div>
                        <div className="col-xl-3 col-6">
                          <div className="content-box">
                            ...
                            <div className="chart-num">
                              <p>Teachers</p>
                              <h2 className="font-w700 mb-0">754</h2>
                            </div>
                          </div>
                        </div>
                        <div className="col-xl-3 col-6">
                          <div className="content-box">
                            ...
                            <div className="chart-num">
                              <p>Events</p>
                              <h2 className="font-w700 mb-0">40</h2>
                            </div>
                          </div>
                        </div>
                        <div className="col-xl-3 col-6">
                          <div className="content-box">
                            ...
                            <div className="chart-num">
                              <p>Foods</p>
                              <h2 className="font-w700 mb-0">32k</h2>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div className="col-xl-6">
                  <div className="card h-auto">
                    <div className="card-header border-0 pb-0 flex-wrap">
                      <h4 className="heading mb-3 mb-sm-0">School Overview</h4>
                      <ul
              ...
              <div className="row">
                <div className="col-xl-4 wow fadeInUp" data-wow-delay="1.5s">
                  <div className="card">
                    ...
                    <div className="card-body text-center event-calender  py-0 px-1">
                      <input
                        type="text"
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td className="text-end">
                                <span className="badge badge-sm light badge-danger">
                                  Bad
                                </span>
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td>$ 218.70</td>
                              <td className="text-end">
                                <span className="badge badge-sm light badge-success">
                                  Good
                                </span>
                              </td>
                            </tr>
                      ...
                      >
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <span className="doller font-w600"> $ 51,038</span>
                            </td>
                            <td>First</td>
                            <td>
                              <ul className="tbl-action">
                          ...
                          <tr>
                            ...
                            <td>
                              <span className="doller font-w600"> $ 52,036</span>
                            </td>
                            <td>First</td>
                            <td>
                              <ul className="tbl-action">
                          ...
                          <tr>
                            ...
                            <td>
                              <span className="doller font-w600"> $ 53,036</span>
                            </td>
                            <td>First</td>
                            <td>
                              <ul className="tbl-action">
                          ...
                          <tr>
                            ...
                            <td>
                              <span className="doller font-w600"> $ 54,036</span>
                            </td>
                            <td>First</td>
                            <td>
                              <ul className="tbl-action">
